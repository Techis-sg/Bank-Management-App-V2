...
class PROFILE():
    ...
    def show_profile(self):
        ...
        self.p_l1 = Label(self.profframe,text='Account No:{}'.format(self.udacc.get()),bg="gray",font=('Times','18','bold'),fg="#000000")
        self.p_l1.grid(row=0,column=0,columnspan=2,padx=64)

        self.p_l2 = Label(self.profframe,text='User Name:{}'.format(self.udname.get()),bg="gray",font=('Times','18','bold'),fg="#000000")
        self.p_l2.grid(row=1,column=0,columnspan=2,padx=64)

        self.p_l3 = Label(self.profframe,text='Balance:{}'.format(self.udbal.get()),bg="gray",font=('Times','18','bold'),fg="#000000")
